/**
 * Traditional Product Configuration
 * Configuration for Traditional pergola products
 */
...
const traditionalConfig = {
    ...
    options: {
        ...
        vinylShadeLevel: {
            label: 'Vinyl Shade Level',
            type: 'select',
            options: ['50%', '75%', '90%'],
            default: '75%',
            required: true,
            group: 'Appearance',
            description: 'Level of shade provided by the vinyl shade'
        },
        capStyle: {
            label: 'Cap Style',
            type: 'select',
    ...
    constraints: [
        ...
        {
            // 90% shade level not available with black color
            condition: (options) => options.color === 'Black',
            affects: 'vinylShadeLevel',
            value: '75%',
            message: '90% shade level is not available with Black color'
        }
    ],
    ...
    features: [
        {
            name: 'Vinyl Shade Roof',
            description: 'Adjustable vinyl shade roof that provides varying levels of shade',
            included: true
        },
        {
...
// Export the Traditional product configuration
