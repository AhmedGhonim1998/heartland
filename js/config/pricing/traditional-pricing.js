/**
 * Traditional Pricing Configuration
 * Pricing configuration for Traditional pergola products
 */

/**
 * Traditional pricing configuration
 */
const traditionalPricingConfig = {
    /**
    ...
    /**
     * Vinyl shade level multipliers
     */
    vinylShadeMultipliers: {
        '50%': 0.9,
        '75%': 1.0,
        '90%': 1.1
    },
    ...
    componentPricing: {
        ...
        structural: {
            ...
            purlins: {
                'White': {
                    '7/8" x 3" Standard Picket - 120"': 12.36,
                    '7/8" x 3" Standard Picket - 144"': 14.83,
                    '7/8" x 3" Standard Picket - 168"': 19.78,
                    '7/8" x 3" Standard Picket - 192"': 19.78,
                    '7/8" x 3" Standard Picket - 240"': 24.72
                },
                'Tan': {
                    '7/8" x 3" Standard Picket - 120"': 13.60,
                    '7/8" x 3" Standard Picket - 144"': 16.32,
                    '7/8" x 3" Standard Picket - 168"': 14.23,
                    '7/8" x 3" Standard Picket - 192"': 21.75,
                    '7/8" x 3" Standard Picket - 240"': 27.19
                },
                'Black': {
                    '7/8" x 3" Standard Picket - 120"': 34.68,
                    '7/8" x 3" Standard Picket - 144"': 34.68,
                    '7/8" x 3" Standard Picket - 168"': 34.68,
                    '7/8" x 3" Standard Picket - 192"': 34.68
                }
            }
        },
        
        /**
         * Vinyl shade components
         */
        vinylShade: {
            /**
             * 50% shade level
             */
            '50%': {
                'Vinyl Shade Panel - 10\'': 150.00,
                'Vinyl Shade Panel - 12\'': 180.00,
                'Vinyl Shade Panel - 14\'': 210.00,
                'Vinyl Shade Panel - 16\'': 240.00,
                'Vinyl Shade Panel - 18\'': 270.00,
                'Vinyl Shade Panel - 20\'': 300.00
            },
             ...
             */
            '75%': {
                'Vinyl Shade Panel - 10\'': 175.00,
                'Vinyl Shade Panel - 12\'': 210.00,
                'Vinyl Shade Panel - 14\'': 245.00,
                'Vinyl Shade Panel - 16\'': 280.00,
                'Vinyl Shade Panel - 18\'': 315.00,
                'Vinyl Shade Panel - 20\'': 350.00
            },
             ...
             */
            '90%': {
                'Vinyl Shade Panel - 10\'': 200.00,
                'Vinyl Shade Panel - 12\'': 240.00,
                'Vinyl Shade Panel - 14\'': 280.00,
                'Vinyl Shade Panel - 16\'': 320.00,
                'Vinyl Shade Panel - 18\'': 360.00,
                'Vinyl Shade Panel - 20\'': 400.00
            }
        },
...
// Export the Traditional pricing configuration
if (typeof module !== 'undefined' && module.exports) {
    module.exports = traditionalPricingConfig;
}
